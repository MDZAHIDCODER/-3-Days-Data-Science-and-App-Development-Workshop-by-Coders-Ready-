...
Original file is located at
    https://colab.research.google.com/drive/1zIJLva6Qoo7stUP6_tYnCrY2FHbyNdpT
"""
...
fig = pr.bar(bar_data,x='DestCityName',y='Flights', title = 'Total number of flights from each destination states')
fig.show()
